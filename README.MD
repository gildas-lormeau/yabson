...
in JavaScript. Note that the binary encoding is also determined by the
endianness of the underlying hardware.

## Example

```js
import { getParser, getSerializer } from "yabson";
// Deno: import { getParser, getSerializer } from "https://deno.land/x/yabson@v1.0.3";
// Browser: import { getParser, getSerializer } from "https://unpkg.com/yabson@1.0.3";
