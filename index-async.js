...
async function serializeBigInt(data, number) {
...
async function parseBigUint64Array(data) {
	const length = await parseValue(data);
...
async function parseBigInt64Array(data) {
	const length = await parseValue(data);
	const array = await data.consume(length * 8);
...
async function parseBigInt(data) {
	const array = await data.consume(8);
